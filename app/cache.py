...
Separates cached data from metadata properly.
"""
...
class ProfessionalCache:
    ...
    def __init__(self, max_size: int = 1000):
        ...
        self.data_cache = OrderedDict()  # For actual data
        self.metadata = {}  # For cache metadata
        self.stats = {
            "hits": 0,
            "misses": 0,
            "sets": 0,
    ...
    def get_daily_prayer_times(self, lat: float, lon: float, date_str: str, country: str) -> Optional[DailyPrayerTimes]:
        ...
        if result and "data" in result:
            try:
                # Convert dict to DailyPrayerTimes object
    ...
    def set_daily_prayer_times(self, lat: float, lon: float, date_str: str, country: str, data: DailyPrayerTimes):
        ...
        # Convert DailyPrayerTimes to dict for storage
        data_dict = data.dict()
